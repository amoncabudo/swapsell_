  ...
  <div class="bg-gray-50 min-h-screen">
    <component :is="isAuthenticated ? AuthenticatedLayout : NavbarS">
      ...
      <div class="wave-bg pt-24 pb-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div class="max-w-3xl mx-auto">
            <div class="relative">
              <input aria-label="search bar" type="text" placeholder="¿Què estàs buscant?" v-model="searchQuery"
                class="w-full pl-12 pr-4 py-4 rounded-xl text-black shadow-lg focus:outline-none focus:ring-2 focus:ring-white/50">
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-8">
        <div class="glass-effect rounded-xl p-4">
          <div class="flex space-x-4 overflow-x-auto py-2">
            ...
            <button v-for="category in categories" :key="category.id" @click="selectedCategory = category.name" :class="[
              'px-4 py-2 rounded-full flex items-center space-x-2',
      ...
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div v-if="searchedProducts" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div class="mt-2 flex items-center justify-between text-sm text-gray-500">
                ...
                <form @submit.prevent>
                  <button aria-label="Favorite Product" @click="toggleFavorite(product)"
                    ...
                    <svg class="h-5 w-5" :fill="product.is_favorite ? 'red' : 'none'" stroke="currentColor"
                      viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div v-else class="text-center py-12">
          <div class="bg-white rounded-lg shadow-md p-8">
            ...
            <h3 class="mt-4 text-lg font-medium text-gray-900">No hi ha productes amb aquesta categoria</h3>
            <p class="mt-2 text-sm text-gray-500">Intenta cercar amb una altra categoria o torna més tard.</p>
          </div>
        </div>
      </div>
      <!-- Floating buttons -->
