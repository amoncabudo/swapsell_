...
Route::post('/products/favorite', [ProductController::class, 'toggleFavourite'])->name('productFavorite');
...
Route::put('adminpanel/users/{id}', [UserController::class, 'update'])->name('users.update');
